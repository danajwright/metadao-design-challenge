    ...
    <div className="border border-[#312d2a] rounded-[3px] relative w-full overflow-hidden shrink-0">
      <div className="flex flex-col gap-[52px] items-start px-6 py-4 relative">
        ...
        <div className="flex gap-[6px] items-center py-[3px] rounded-[5px]">
          ...
          <span className="font-['Inter',sans-serif] font-medium text-[12px] text-[#8aea92] leading-4">
        ...
        {/* Title */}
        <h2 className="font-['IBM_Plex_Mono',monospace] text-[21px] text-[#f7e7d3] leading-8 whitespace-nowrap">
        ...
        <div className="flex gap-[42px] items-start">
          <div className="flex flex-col gap-[2px] items-start">
            ...
            <span className="font-['IBM_Plex_Mono',monospace] text-[14px] text-[#f4e4cf] leading-7">
          ...
          <div className="flex flex-col gap-[2px] items-start">
            ...
            <span className="font-['IBM_Plex_Mono',monospace] text-[14px] text-[#f4e4cf] leading-7 w-[216px]">
